...
class HomeView(TemplateView):
    template_name = "formularios/home.html"


class SolicitudCreateView(FormView):    
    form_class = SolicitudForm
    template_name = 'formularios/solicitud_form.html'
    success_url = reverse_lazy('formularios:solicitud_review')
...
class SolicitudReviewView(TemplateView):    
    template_name = 'formularios/solicitud_review.html'    
...
class SolicitudUpdateView(FormView):    
    ...
    def get_success_url(self):
        return reverse_lazy('formularios:solicitud_review')
'''
class SolicitudConfirmView(TemplateView):    
    template_name = 'formularios/solicitud_confirmar.html'
...
class SolicitudConfirmView(TemplateView):    
    ...
    def post(self, request, *args, **kwargs):
        ...
        if form_data:            
            ...
            html_message = render_to_string('formularios/email_template.html', {'solicitud': solicitud})
...
class SolicitudListView(LoginRequiredMixin, ListView):
    model = Solicitud
    template_name = 'formularios/solicitud_list.html'
    context_object_name = 'formularios'    

class SolicitudDeleteView(LoginRequiredMixin, DeleteView):
    model = Solicitud
    template_name = 'formularios/solicitud_confirm_delete.html'
    success_url = reverse_lazy('formularios:solicitud_list')
...
class GenerarDocumentoView(LoginRequiredMixin, DetailView):
    model = Solicitud
    template_name = 'formularios/generar_documento.html'  
    ...
    def get(self, request, *args, **kwargs):
        ...
        return redirect('formularios:descargar_documento', file_name=file_name)
