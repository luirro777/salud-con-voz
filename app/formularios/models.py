...
class Solicitud(models.Model):
    #Informacion referida al tipo de cuestionario
    TIPO_CUESTIONARIO_CHOICES = [
        ('KIDSCREEN', 'KIDSCREEN: Genérico de CVRS en niñas, niños y jóvenes'),
        ('CP-QOL',     'CP-QOL: CVRS en personas con discapacidad motora'),
        ('TWVQ-AR',    'TWVQ-AR: Percepción de la voz y vivencias de mujeres trans'),
        ('VRBQ',       'VRBQ: Evaluación de rehabilitación de trastornos vestibulares'),
    ]

    tipo_cuestionario = models.CharField(
        max_length=20,
        choices=TIPO_CUESTIONARIO_CHOICES,
