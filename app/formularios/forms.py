...
class SolicitudForm(forms.ModelForm):
    ...
    class Meta:
        ...
        widgets = {
            'tipo_cuestionario': forms.Select(
                attrs={'class': 'form-select'}  # o 'form-control' si usas Bootstrap <5
            ),
            'objetivo': forms.Textarea(attrs={'rows': 3}),
            'descripcion_metodologia': forms.Textarea(attrs={'rows': 5}),
            'caracteristicas_poblacion': forms.Textarea(attrs={'rows': 5}),
            'estudiantes': forms.Textarea(attrs={'rows': 5}),
        ...
        labels = {
            ...
            'uso_curricular': '¿Los cuestionarios se implementarán en el marco de una Tesis o trabajo académico de grado, posgrado u otra?',
            'carrera_posgrado': 'Nombre de la Carrera en la que implementará el estudio con este cuestionario',
            'estudiantes': 'Nombres y apellidos de la/s persona/s en formación de grado o posgrado que lo utilizarán en el marco de su Tesis/Tesina',
            'responsables_orientacion': 'Nombre de Director/a de Tesis (o bien, tutor/a o rol similar)',            
            'titulo_estudio': 'Título del Estudio (al menos tentativo) ',
            'objetivo': 'Objetivo',
            'descripcion_metodologia': 'Descripción de la Metodología',
            'caracteristicas_poblacion': 'Características de la Población: por favor, en lo posible detalle población y muestra',
            'utilidad_estudio': 'Utilidad del Estudio: por favor, indique qué contribuciones o aportes se esperan a partir de la ejecución del estudio y de los resultados que se obtengan, a qué institución (u otros beneficiarios) se ofrecerán los resultados, etc.',
            'institucion_avala': 'Institución que Avala: por favor, indique cuáles son las instituciones que evaluarán, acreditarán y/o financiarán el estudio, según corresponda en su caso (por ejemplo, organismos universitarios o científicos, comités de ética, entidades privadas con o sin fines de lucro, etc)',
        }
