# Generated by Django 5.0.8 on 2025-09-10 18:20
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('persona_ocupa', models.CharField(choices=[('madre', 'Madre'), ('padre', 'Padre'), ('tutor_legal', 'Tutor/a legal'), ('pareja_madre_padre', 'Pareja de la madre o el padre'), ('abuelo_abuela', 'Abuela/o'), ('hermano_hermana', 'Hermana/o'), ('otro_familiar', 'Otro familiar ¿Cuál?'), ('otra_persona_no_familiar', 'Otra persona, no familiar ¿Cuál?')], max_length=100, verbose_name='¿Quién es la persona que se ocupa principalmente del cuidado del niño, niña adolescente o jóven?')),
                ('max_estudios', models.CharField(choices=[('1. No fue a la escuela', '1. No fue a la escuela'), ('2. Primaria incompleta (comenzó, pero no terminó la escuela primaria)', '2. Primaria incompleta (comenzó, pero no terminó la escuela primaria)'), ('3. Primaria completa', '3. Primaria completa'), ('4. Secundaria incompleta (comenzó, pero no terminó la secundaria)', '4. Secundaria incompleta (comenzó, pero no terminó la secundaria)'), ('5. Secundaria completa', '5. Secundaria completa'), ('6. Terciario o universitario incompleto (los comenzó, pero no los terminó)a', '6. Terciario o universitario incompleto (los comenzó, pero no los terminó)'), ('7. Terciario completo', '7. Terciario completo'), ('8. Universitario de grado completo o posgrado completo', '8. Universitario de grado completo o posgrado completo')], max_length=100, verbose_name='¿Cuál es el nivel máximo de estudios finalizado por la madre o cuidador/a del niño/a, adolescente o jóven?')),
                ('edad', models.PositiveIntegerField(validators=[django.core.validators.MaxValueValidator(18, 'La edad no puede superar los 18 años')], verbose_name='Edad del niño, niña, adolescente o jóven:')),
                ('genero', models.CharField(choices=[('femenino', 'Femenino'), ('masculino', 'Masculino'), ('no_binario', 'No binario'), ('otro', 'Otro ¿cuál?')], max_length=100, verbose_name='Género del niño, niña, adolescente o jóven')),
            ],
        ),
        migrations.CreateModel(
            name='DatosClinicos',
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('gmfcs', models.CharField(choices=[('nivel_i', 'Nivel I'), ('nivel_ii', 'Nivel II'), ('nivel_iii', 'Nivel III'), ('nivel_iv', 'Nivel IV'), ('nivel_v', 'Nivel V')], max_length=100, verbose_name='Sistema de la Clasificación de la Función Motora Gruesa (GMFCS)')),
                ('macs', models.CharField(choices=[('nivel_i', 'Nivel I'), ('nivel_ii', 'Nivel II'), ('nivel_iii', 'Nivel III'), ('nivel_iv', 'Nivel IV'), ('nivel_v', 'Nivel V')], max_length=100, verbose_name='Sistema de Clasificación de la Habilidad Manual (MACS)')),
                ('cfcs', models.CharField(choices=[('nivel_i', 'Nivel I'), ('nivel_ii', 'Nivel II'), ('nivel_iii', 'Nivel III'), ('nivel_iv', 'Nivel IV'), ('nivel_v', 'Nivel V')], max_length=100, verbose_name='Sistema de Clasificación de Comunicación Funcional (CFCS)')),
                ('edacs', models.CharField(choices=[('nivel_i', 'Nivel I'), ('nivel_ii', 'Nivel II'), ('nivel_iii', 'Nivel III'), ('nivel_iv', 'Nivel IV'), ('nivel_v', 'Nivel V')], max_length=100, verbose_name='Sistema de Clasificación para la capacidad de Comer y Beber (EDACS)')),
            ],
        ),
        migrations.CreateModel(
            name='Dolor',
            fields=[
                ...
                ('promedio', models.FloatField(blank=True, default=0.0, null=True)),
            ],
        ),
        migrations.CreateModel(
            name='Escuela',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('correo', models.EmailField(blank=True, default='correo@ejemplo.com', max_length=254, null=True)),
            ],
        ),
        migrations.CreateModel(
            name='Hogar',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('movimiento', models.IntegerField(default=1, validators=[django.core.validators.MinValueValidator(1), django.core.validators.MaxValueValidator(5)], verbose_name='Por favor lea las 5 posibles situaciones descritas antes de contestar. Seleccione sólo una opción, marcando el casillero. Elija la que mejor describa de manera general, la capacidad de su hijo/a para moverse.')),
                ('promedio', models.FloatField(blank=True, default=0.0, null=True)),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('genero', models.CharField(choices=[('femenino', 'Femenino'), ('masculino', 'Masculino'), ('no-binario', 'No binario'), ('otro', 'Otro')], max_length=20, verbose_name='Género [Del niño/a o adolescente]')),
                ...
                ('cobertura', models.JSONField(blank=True, null=True, verbose_name='¿Qué tipo de cobertura de salud tiene su hijo/a actualmente?')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('profesion', models.CharField(choices=[('medico_familia', 'Médico/a de familia/general'), ('medico_fisiatra', 'Médico/a fisiatra'), ('medico_especialista', 'Médico/a especialista'), ('fonoaudiologo', 'Fonoaudiólogo/a'), ('kinesiologo', 'Kinesiólogo/a'), ('terapista_ocupacional', 'Terapista Ocupacional'), ('nutricionista', 'Nutricionista'), ('psicologo', 'Psicólogo/a'), ('trabajador_social', 'Trabajador/a social'), ('docente_inclusion', 'Docente de inclusión'), ('acompanante_terapeutico', 'Acompañante terapéutica/o'), ('otra', 'Otra')], max_length=100, verbose_name='Por favor, marque la profesión que mejor le describa')),
                ('provincia_atencion', models.CharField(max_length=100, verbose_name='Por favor, consigne la provincia en la que atiende al niño, niña, adolescente o jóven')),
                ('ciudad_atencion', models.CharField(verbose_name='Ciudad o localidad donde atiende al NNAJ')),
                ('tipo_centro', models.CharField(choices=[('centro_privado', 'Centro o clínica privada'), ('centro_publico', 'Hospital u otro tipo de centro público'), ('consultorio_particular', 'Consultorio particular'), ('otro', 'Otro ¿Cuál?')], max_length=100, verbose_name='Por favor, indique el tipo de centro o servicio de salud en el que trabaja:')),
                ('centro_salud', models.CharField(max_length=100, verbose_name="Por favor, consigne el nombre del centro o servicio de salud en el que trabaja (si es consultorio particular escriba 'consultorio particular'):")),
                ('especialidad', models.CharField(blank=True, max_length=255, null=True, verbose_name='Qué especialidad?')),
                ('profesion_otra', models.CharField(blank=True, max_length=255, null=True, verbose_name='Cuál?')),
                ('tipo_centro_otro', models.CharField(blank=True, max_length=255, null=True, verbose_name='Cuál?')),
            ],
        ),
        migrations.CreateModel(
            name='Relaciones',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('caminar_2', models.CharField(choices=[('No tiene problemas en ese aspecto', 'No tiene problemas en ese aspecto'), ('Nunca', 'Nunca'), ('Casi Nunca', 'Casi Nunca'), ('Algunas Veces', 'Algunas Veces'), ('Casi Siempre', 'Casi Siempre'), ('Siempre', 'Siempre')], max_length=100, verbose_name='¿A su hijo/a le molesta no poder caminar sin ayuda?')),
                ('bañarse_2', models.CharField(choices=[('No tiene problemas en ese aspecto', 'No tiene problemas en ese aspecto'), ('Nunca', 'Nunca'), ('Casi Nunca', 'Casi Nunca'), ('Algunas Veces', 'Algunas Veces'), ('Casi Siempre', 'Casi Siempre'), ('Siempre', 'Siempre')], max_length=100, verbose_name='¿A su hijo/a le molesta que lo/a tenga que vestir y bañar otra persona?')),
                ('ir_baño_2', models.CharField(choices=[('No tiene problemas en ese aspecto', 'No tiene problemas en ese aspecto'), ('Nunca', 'Nunca'), ('Casi Nunca', 'Casi Nunca'), ('Algunas Veces', 'Algunas Veces'), ('Casi Siempre', 'Casi Siempre'), ('Siempre', 'Siempre')], max_length=100, verbose_name='¿A su hijo/a le molesta que lo/a tengan que ayudar para ir al baño?')),
                ('comunicarse_2', models.CharField(choices=[('No tiene problemas en ese aspecto', 'No tiene problemas en ese aspecto'), ('Nunca', 'Nunca'), ('Casi Nunca', 'Casi Nunca'), ('Algunas Veces', 'Algunas Veces'), ('Casi Siempre', 'Casi Siempre'), ('Siempre', 'Siempre')], max_length=100, verbose_name='¿Su hijo/a se puede comunicar tan bien como quiere?')),
                ('hablar_2', models.CharField(choices=[('No tiene problemas en ese aspecto', 'No tiene problemas en ese aspecto'), ('Nunca', 'Nunca'), ('Casi Nunca', 'Casi Nunca'), ('Algunas Veces', 'Algunas Veces'), ('Casi Siempre', 'Casi Siempre'), ('Siempre', 'Siempre')], max_length=100, verbose_name='¿A su hijo/a le molesta no poder hablar tan bien como los demás chicos/as?')),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('fisicamente', models.CharField(choices=[('Muchísimo', 'Muchísimo'), ('Mucho', 'Mucho'), ('Moderadamente', 'Moderadamente'), ('Un poco', 'Un poco'), ('Nada', 'Nada')], max_length=100, verbose_name='¿El chico/a se sintió bien y físicamente en forma?')),
                ('energia', models.CharField(choices=[('Siempre', 'Siempre'), ('Casi siempre', 'Casi siempre'), ('Algunas veces', 'Algunas veces'), ('Casi nunca', 'Casi nunca'), ('Nunca', 'Nunca')], max_length=100, verbose_name='¿El chico/a se sintió lleno/a de energía?')),
                ('tristeza', models.CharField(choices=[('Siempre', 'Siempre'), ('Casi siempre', 'Casi siempre'), ('Algunas veces', 'Algunas veces'), ('Casi nunca', 'Casi nunca'), ('Nunca', 'Nunca')], max_length=100, verbose_name='¿El chico/a se sintió triste?')),
                ('soledad', models.CharField(choices=[('Siempre', 'Siempre'), ('Casi siempre', 'Casi siempre'), ('Algunas veces', 'Algunas veces'), ('Casi nunca', 'Casi nunca'), ('Nunca', 'Nunca')], max_length=100, verbose_name='¿El chico/a se sintió solo/a?')),
                ('tiempo_libre', models.CharField(choices=[('Siempre', 'Siempre'), ('Casi siempre', 'Casi siempre'), ('Algunas veces', 'Algunas veces'), ('Casi nunca', 'Casi nunca'), ('Nunca', 'Nunca')], max_length=100, verbose_name='¿El chico/a tuvo suficiente tiempo para él/ella?')),
                ('cosas_queria', models.CharField(choices=[('Siempre', 'Siempre'), ('Casi siempre', 'Casi siempre'), ('Algunas veces', 'Algunas veces'), ('Casi nunca', 'Casi nunca'), ('Nunca', 'Nunca')], max_length=100, verbose_name='¿El chico/a hizo las cosas que quería hacer en su tiempo libre?')),
                ('justicia', models.CharField(choices=[('Siempre', 'Siempre'), ('Casi siempre', 'Casi siempre'), ('Algunas veces', 'Algunas veces'), ('Casi nunca', 'Casi nunca'), ('Nunca', 'Nunca')], max_length=100, verbose_name='¿Los padres del chico/a fueron justos con él/ella?')),
                ('diversion', models.CharField(choices=[('Siempre', 'Siempre'), ('Casi siempre', 'Casi siempre'), ('Algunas veces', 'Algunas veces'), ('Casi nunca', 'Casi nunca'), ('Nunca', 'Nunca')], max_length=100, verbose_name='¿El chico/a se divirtió con sus amigos/as?')),
                ('colegio', models.CharField(choices=[('Muchísimo', 'Muchísimo'), ('Mucho', 'Mucho'), ('Moderadamente', 'Moderadamente'), ('Un poco', 'Un poco'), ('Nada', 'Nada')], max_length=100, verbose_name='¿Al chico/a le fue bien en la escuela o en el colegio?')),
                ('atencion', models.CharField(choices=[('Siempre', 'Siempre'), ('Casi siempre', 'Casi siempre'), ('Algunas veces', 'Algunas veces'), ('Casi nunca', 'Casi nunca'), ('Nunca', 'Nunca')], max_length=100, verbose_name='¿El chico/a pudo prestar atención en clase?')),
            ],
        ),
        migrations.CreateModel(
            name='Sentimientos',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('genero', models.CharField(choices=[('femenino', 'Femenino'), ('masculino', 'Masculino'), ('no-binario', 'No binario'), ('otro', 'Otro')], max_length=20, verbose_name='Género [de la persona que responde]')),
                ('genero_otro', models.CharField(blank=True, max_length=20, null=True, verbose_name='¿Cuál?')),
            ],
        ),
        migrations.CreateModel(
            name='CpqolProfesional',
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ...
                ('contexto', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.PROTECT, to='core.contexto')),
                ('user', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.PROTECT, to=settings.AUTH_USER_MODEL)),
                ('datos_clinicos', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.PROTECT, to='core.datosclinicos')),
                ('correo', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.PROTECT, to='core.finalizacion')),
                ('profesional', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.PROTECT, to='core.profesional')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('correo', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.PROTECT, to='core.finalizacion')),
                ('hogar', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.PROTECT, to='core.hogar')),
                ('movimiento', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.PROTECT, to='core.movimiento')),
                ...
                ('salud_ultima_semana', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.PROTECT, to='core.saludultimasemana')),
                ('salud_ultima_semana_2', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.PROTECT, to='core.saludultimasemana2')),
