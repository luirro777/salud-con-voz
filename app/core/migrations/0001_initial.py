# Generated by Django 5.0.8 on 2025-02-24 20:49
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('fisicamente', models.CharField(choices=[('Muchísimo', 'Muchísimo'), ('Un poco', 'Un poco'), ('Mucho', 'Mucho'), ('Moderadamente', 'Moderadamente'), ('Nada', 'Nada')], max_length=100, verbose_name='¿El chico/a se sintió bien y físicamente en forma?')),
                ('energia', models.CharField(choices=[('Muchísimo', 'Muchísimo'), ('Un poco', 'Un poco'), ('Mucho', 'Mucho'), ('Moderadamente', 'Moderadamente'), ('Nada', 'Nada')], max_length=100, verbose_name='¿El chico/a se sintió lleno/a de energía?')),
                ('tristeza', models.CharField(choices=[('Muchísimo', 'Muchísimo'), ('Un poco', 'Un poco'), ('Mucho', 'Mucho'), ('Moderadamente', 'Moderadamente'), ('Nada', 'Nada')], max_length=100, verbose_name='¿El chico/a se sintió triste?')),
                ('soledad', models.CharField(choices=[('Muchísimo', 'Muchísimo'), ('Un poco', 'Un poco'), ('Mucho', 'Mucho'), ('Moderadamente', 'Moderadamente'), ('Nada', 'Nada')], max_length=100, verbose_name='¿El chico/a se sintió solo/a?')),
                ('tiempo_libre', models.CharField(choices=[('Muchísimo', 'Muchísimo'), ('Un poco', 'Un poco'), ('Mucho', 'Mucho'), ('Moderadamente', 'Moderadamente'), ('Nada', 'Nada')], max_length=100, verbose_name='¿El chico/a tuvo suficiente tiempo para él/ella?')),
                ('cosas_queria', models.CharField(choices=[('Muchísimo', 'Muchísimo'), ('Un poco', 'Un poco'), ('Mucho', 'Mucho'), ('Moderadamente', 'Moderadamente'), ('Nada', 'Nada')], max_length=100, verbose_name='¿El chico/a hizo las cosas que quería hacer en su tiempo libre?')),
                ('justicia', models.CharField(choices=[('Muchísimo', 'Muchísimo'), ('Un poco', 'Un poco'), ('Mucho', 'Mucho'), ('Moderadamente', 'Moderadamente'), ('Nada', 'Nada')], max_length=100, verbose_name='¿Los padres del chico/a fueron justos con él/ella?')),
                ('diversion', models.CharField(choices=[('Muchísimo', 'Muchísimo'), ('Un poco', 'Un poco'), ('Mucho', 'Mucho'), ('Moderadamente', 'Moderadamente'), ('Nada', 'Nada')], max_length=100, verbose_name='¿El chico/a se divirtió con sus amigos/as?')),
                ('colegio', models.CharField(choices=[('Muchísimo', 'Muchísimo'), ('Un poco', 'Un poco'), ('Mucho', 'Mucho'), ('Moderadamente', 'Moderadamente'), ('Nada', 'Nada')], max_length=100, verbose_name='¿Al chico/a le fue bien en la escuela o en el colegio?')),
                ('atencion', models.CharField(choices=[('Muchísimo', 'Muchísimo'), ('Un poco', 'Un poco'), ('Mucho', 'Mucho'), ('Moderadamente', 'Moderadamente'), ('Nada', 'Nada')], max_length=100, verbose_name='¿El chico/a pudo prestar atención en clase?')),
            ],
        ),
        migrations.CreateModel(
            name='Sentimientos',
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('movimiento', models.IntegerField(blank=True, choices=[(1, 'Tiene dificultad para mantenerse sentado y para poder controlar la cabeza y el tronco en cualquier posición.'), (2, 'Puede mantenerse sentado con algún soporte en pelvis o en tronco, pero no estar de pie, ni caminar sin gran ayuda.'), (3, 'Es capaz de mantenerse de pie por sí mismo y de caminar, sólo si usa alguna ayuda para la marcha (como un andador, muletas, bastones, etc.)'), (4, 'Puede caminar sin ayudas para la marcha, pero necesita apoyarse en el pasamano para subir y bajar escaleras.'), (5, 'Puede caminar sin ayudas para la marcha y subir y bajar escaleras sin necesidad de apoyarse en el pasamano.')], default=None, null=True, validators=[django.core.validators.MinValueValidator(1), django.core.validators.MaxValueValidator(5)], verbose_name='Por favor lea las 5 posibles situaciones descritas antes de contestar. Seleccione sólo una opción, marcando el casillero. Elija la que mejor describa de manera general, la capacidad de su hijo/a para moverse.')),
